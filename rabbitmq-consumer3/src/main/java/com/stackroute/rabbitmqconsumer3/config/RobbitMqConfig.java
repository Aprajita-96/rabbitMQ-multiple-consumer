package com.stackroute.rabbitmqconsumer3.config;
...
public class RobbitMqConfig {
    ...
    // Binding key for third consumer
    public static final String BINDING_KEY = "my.routing3.key";

    //Name of Exchange
    public static final String EXCHANGE_NAME = "my.exchange.topic";

    //Queue name for Second queue
    public static final String QUEUE_NAME = "my.queue3.name";
    ...
    /**
     * binding() method will bind the third queue to topic exchange with
     * binding key attribute for third consumer
     *
     * @return Binding
     */
    @Bean
