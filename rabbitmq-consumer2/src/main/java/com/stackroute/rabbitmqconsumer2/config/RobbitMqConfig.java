package com.stackroute.rabbitmqconsumer2.config;
...
public class RobbitMqConfig {
    ...
    // Binding key for Second consumer
    public static final String BINDING_KEY = "my.routing2.key";

    //Name of Exchange
    public static final String EXCHANGE_NAME = "my.exchange.topic";

    //Queue name for Second queue
    public static final String QUEUE_NAME = "my.queue2.name";


    /**
     * Creating a bean for Second queue
     *
     * @return queue
     */
    @Bean
    ...
    /**
     * binding() method will bind the second queue to topic exchange with
     * binding key attribute for second consumer
     *
     * @return Binding
     */
    @Bean
